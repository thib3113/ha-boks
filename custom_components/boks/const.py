...
TIMEOUT_LOG_COUNT_STABILIZATION = 0.5  # Time to wait for potentially multiple log count responses (increased for stability)
...
TPL_DELETE_TOKEN = "[[DELETE_TOKEN]]"
WEBHOOK_DELETE_PACKAGE = "boks_delete_update_package"
