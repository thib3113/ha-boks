...
from custom_components.boks.sensors.diagnostics.battery_diagnostic_sensor import (
    BoksBatteryDiagnosticSensor,
)
from custom_components.boks.sensors.diagnostics.battery_format_sensor import (
    BoksBatteryFormatSensor,
)
from custom_components.boks.sensors.diagnostics.battery_type_sensor import (
