...
*   **Redémarrage de l'Intégration/Home Assistant** : Parfois, un simple redémarrage de l'intégration Boks (depuis Appareils et Services -> Boks -> Recharger) ou de Home Assistant lui-même peut résoudre les problèmes de découverte.
...
### 4. L'intégration devient indisponible ou déconnectée
